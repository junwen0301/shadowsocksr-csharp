    ...
    public class MenuViewController
    {
        ...
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                ...
                CreateMenuGroup("Unusual function", new MenuItem[] {
                    ...
                    CreateMenuItem("Update local PAC from GFWList", new EventHandler(this.UpdatePACFromGFWListItem_Click)),
                    new MenuItem("-"),
                    CreateMenuItem("Purchase...", new EventHandler(this.Purchase_Click)),
                    CreateMenuItem("About...", new EventHandler(this.AboutItem_Click)),
                    //CreateMenuItem("Donate...", new EventHandler(this.DonateItem_Click)),
                }),
        ...
        {
            Process.Start("https://github.com/junwen0301/FREE-shadowsock-VPN/blob/master/README.md");
        }
        ...
        {
            Process.Start("https://github.com/junwen0301/shadowsocksr-csharp");
        }
