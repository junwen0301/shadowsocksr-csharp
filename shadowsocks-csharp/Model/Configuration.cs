...
namespace Shadowsocks.Model
{
    ...
    public class ServerSubscribe
    {
        ...
        //private static string OLD_DEFAULT_FEED_URL = "https://raw.githubusercontent.com/junwen0301/FREE-shadowsock-VPN/master/freenode.txt";

        public string URL = NONE;
        public string Group = "请把有效订阅黏贴入上方框框中，多余无效订阅要删掉哦~";
    }
